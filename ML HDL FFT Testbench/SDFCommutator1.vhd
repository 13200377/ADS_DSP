-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Tood\OneDrive - UTS\Uni\2021 Spring\Embedded Studio A\HDL CODER MATLAB\HDL Output with testbench\FFT_DUT\SDFCommutator1.vhd
...
-- Source Path: FFT_DUT/HDL_DUT/FFT HDL Optimized/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  SIGNAL xX_re                            : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL xX_im                            : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_XState, SDFCummutator_out_im, SDFCummutator_out_re,
       ...
       dinXTwdlf_im, dinXTwdlf_re, din_1_vld_dly, dinxTwdlf_vld)
  BEGIN

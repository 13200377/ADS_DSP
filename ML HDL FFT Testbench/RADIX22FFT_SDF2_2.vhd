-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Tood\OneDrive - UTS\Uni\2021 Spring\Embedded Studio A\HDL CODER MATLAB\HDL Output with testbench\FFT_DUT\RADIX22FFT_SDF2_2.vhd
...
-- Source Path: FFT_DUT/HDL_DUT/FFT HDL Optimized/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    signed(17 DOWNTO 0);  -- sfix18
          xf_im                           :   IN    signed(17 DOWNTO 0);  -- sfix18
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          dinf_im                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          btf1_im                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          btf2_re                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          btf2_im                         :   IN    signed(17 DOWNTO 0);  -- sfix18
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   signed(17 DOWNTO 0);  -- sfix18
          wrData_im                       :   OUT   signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL wrData_im                        : signed(17 DOWNTO 0);  -- sfix18
...
BEGIN
  ...
  din_re <= resize(dout_1_1_re, 18);

  din_im <= resize(dout_1_1_im, 18);

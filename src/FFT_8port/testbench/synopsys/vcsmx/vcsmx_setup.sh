...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/auk_dspip_text_pkg.vhd"               -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/auk_dspip_math_pkg.vhd"               -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/auk_dspip_lib_pkg.vhd"                -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/auk_dspip_roundsat.vhd"               -work fft_ii_0                 
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/FFT_8port_fft_ii_0.sv"                -work fft_ii_0                 
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_conduit_bfm_0002_vhdl_pkg.vhd" -work FFT_8port_inst_source_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_conduit_bfm_0002.vhd"          -work FFT_8port_inst_source_bfm
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_conduit_bfm_vhdl_pkg.vhd"      -work FFT_8port_inst_sink_bfm  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_conduit_bfm.vhd"               -work FFT_8port_inst_sink_bfm  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_avalon_reset_source.vhd"       -work FFT_8port_inst_rst_bfm   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/altera_avalon_clock_source.vhd"       -work FFT_8port_inst_clk_bfm   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/submodules/FFT_8port.vhd"                        -work FFT_8port_inst           
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/FFT_8port_tb/simulation/FFT_8port_tb.vhd"                                                               
fi

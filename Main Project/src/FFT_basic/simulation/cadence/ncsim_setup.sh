...
# ACDS 20.1 711 win32 2021.08.23.13:11:43
...
# ----------------------------------------
# If fft_attempt1 is one of several IP cores in your
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/fft_attempt1_fft_ii_0_opt_twr1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_attempt1_fft_ii_0_opt_twi1.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft_attempt1_fft_ii_0.sv" -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fft_attempt1.vhd"                                                                      
fi

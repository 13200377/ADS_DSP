-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Tood\OneDrive - UTS\Uni\2021 Spring\Embedded Studio A\HDL CODER MATLAB\HDL Output with testbench\FFT_DUT\Complex3Multiply.vhd
...
-- Source Path: FFT_DUT/HDL_DUT/FFT HDL Optimized/RADIX22FFT_SDF1_3/Complex3Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex3Multiply IS
  ...
  SIGNAL din_sum                          : signed(19 DOWNTO 0);  -- sfix20
  ...
  SIGNAL prodOfRe                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  SIGNAL prodOfIm                         : signed(34 DOWNTO 0) := to_signed(0, 35);  -- sfix35_En14
  SIGNAL prodOfSum                        : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En14
  ...
  SIGNAL Complex3Add_tmpResult_reg_next   : signed(36 DOWNTO 0);  -- sfix37_En14
  SIGNAL Complex3Add_multRes_re_reg1_next : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_multRes_re_reg2_next : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_multRes_im_reg_next  : signed(37 DOWNTO 0);  -- sfix38_En14
  SIGNAL Complex3Add_sub_cast             : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_sub_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_sub_cast_2           : signed(37 DOWNTO 0);  -- sfix38_En14
  SIGNAL Complex3Add_sub_cast_3           : signed(37 DOWNTO 0);  -- sfix38_En14
  SIGNAL Complex3Add_add_cast             : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_add_cast_1           : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL Complex3Add_add_temp             : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL multResFP_re                     : signed(35 DOWNTO 0);  -- sfix36_En14
  SIGNAL multResFP_im                     : signed(37 DOWNTO 0);  -- sfix38_En14
...
BEGIN
  ...
  din_sum <= resize(din_re_reg, 20) + resize(din_im_reg, 20);
  ...
  adder_add_cast <= resize(twdl_re_reg, 17);
  adder_add_cast_1 <= resize(twdl_im_reg, 17);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        dinXTwdl_3_vld <= Complex3Add_prod_vld_reg1;
  ...
  dinXTwdl_re <= multResFP_re(32 DOWNTO 14) + ('0' & (multResFP_re(13) AND (( NOT multResFP_re(35)) OR (multResFP_re(12) OR multResFP_re(11) OR multResFP_re(10) OR multResFP_re(9) OR multResFP_re(8) OR multResFP_re(7) OR multResFP_re(6) OR multResFP_re(5) OR multResFP_re(4) OR multResFP_re(3) OR multResFP_re(2) OR multResFP_re(1) OR multResFP_re(0)))));

  dinXTwdl_im <= multResFP_im(32 DOWNTO 14) + ('0' & (multResFP_im(13) AND (( NOT multResFP_im(37)) OR (multResFP_im(12) OR multResFP_im(11) OR multResFP_im(10) OR multResFP_im(9) OR multResFP_im(8) OR multResFP_im(7) OR multResFP_im(6) OR multResFP_im(5) OR multResFP_im(4) OR multResFP_im(3) OR multResFP_im(2) OR multResFP_im(1) OR multResFP_im(0)))));

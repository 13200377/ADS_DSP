-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Tood\OneDrive - UTS\Uni\2021 Spring\Embedded Studio A\HDL CODER MATLAB\HDL Output with testbench\FFT_DUT\SDFCommutator3.vhd
...
-- Source Path: FFT_DUT/HDL_DUT/FFT HDL Optimized/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator3 IS
  ...
  SIGNAL xX_re                            : signed(18 DOWNTO 0);  -- sfix19
  SIGNAL xX_im                            : signed(18 DOWNTO 0);  -- sfix19
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    dout_3_re <= SDFOutmux_btf2Pipe_re;
    dout_3_im <= SDFOutmux_btf2Pipe_im;
